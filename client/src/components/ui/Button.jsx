...
export default function Button({
  ...
  const varinats = {
    ...
    ghost:
      " inline-flex items-center justify-center  font-medium tracking-wide transition duration-300 rounded focus-visible:outline-none justify-self-center whitespace-nowrap bg-indigo-50 text-indigo-500 hover:bg-indigo-100 hover:text-indigo-600 focus:bg-indigo-200 focus:text-indigo-700 disabled:cursor-not-allowed disabled:border-indigo-300 cursor-pointer disabled:bg-indigo-100 disabled:text-indigo-400 disabled:shadow-none w-full ",
    secondary:
